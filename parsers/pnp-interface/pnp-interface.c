...
static INTERFACE_TABLE_ENTRY _interfaceTable[] = {
	...
	{&GUID_BTHDDI_SDP_PARSE_INTERFACE, L"GUID_BTHDDI_SDP_PARSE_INTERFACE"},
	{&GUID_BTHDDI_PROFILE_DRIVER_INTERFACE, L"GUID_BTHDDI_PROFILE_DRIVER_INTERFACE"},
	{&GUID_BTH_DEVICE_INTERFACE, L"GUID_BTH_DEVICE_INTERFACE"},
	{&GUID_BTHDDI_SDP_NODE_INTERFACE, L"GUID_BTHDDI_SDP_NODE_INTERFACE"},
};
