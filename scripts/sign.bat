...
set FILES=irpmon.exe irpmndrv.sys kbase.dll regman.dll irpmondll.dll hexer.dll secdesc.dll pnp-ids.dll pnp-devcaps.dll pnp-interface.dll keyboard.dll pbase.dll
