...
set CONFIG=%1%
set FILES=..\bin\x64\%CONFIG%\irpmon.exe ..\bin\x64\%CONFIG%\irpmndrv.sys ..\bin\x64\%CONFIG%\kbase.dll ..\bin\x64\%CONFIG%\regman.dll ..\bin\x64\%CONFIG%\irpmondll.dll ..\bin\x64\%CONFIG%\hexer.dll ..\bin\x64\%CONFIG%\secdesc.dll ..\bin\x64\%CONFIG%\pnp-ids.dll ..\bin\x64\%CONFIG%\pnp-devcaps.dll ..\bin\x64\%CONFIG%\pnp-interface.dll ..\bin\x64\%CONFIG%\keyboard.dll ..\bin\x64\%CONFIG%\mouse.dll ..\bin\x64\%CONFIG%\pbase.dll ..\bin\Win32\%CONFIG%\irpmon.exe ..\bin\Win32\%CONFIG%\irpmndrv.sys ..\bin\Win32\%CONFIG%\kbase.dll ..\bin\Win32\%CONFIG%\regman.dll ..\bin\Win32\%CONFIG%\irpmondll.dll ..\bin\Win32\%CONFIG%\hexer.dll ..\bin\Win32\%CONFIG%\secdesc.dll ..\bin\Win32\%CONFIG%\pnp-ids.dll ..\bin\Win32\%CONFIG%\pnp-devcaps.dll ..\bin\Win32\%CONFIG%\pnp-interface.dll ..\bin\Win32\%CONFIG%\keyboard.dll ..\bin\Win32\%CONFIG%\mouse.dll ..\bin\Win32\%CONFIG%\pbase.dll
